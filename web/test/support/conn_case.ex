defmodule KlixWeb.ConnCase do
  ...
  by setting `use KlixWeb.ConnCase, async: true`, although
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = Klix.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Klix.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
